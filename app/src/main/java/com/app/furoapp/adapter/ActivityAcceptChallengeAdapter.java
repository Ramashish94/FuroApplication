...
public class ActivityAcceptChallengeAdapter extends RecyclerView.Adapter<ActivityAcceptChallengeAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public ActivityAcceptChallengeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.accept_challenge_activity_item, parent, false);
        return new ActivityAcceptChallengeAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ActivityAcceptChallengeAdapter.MyViewHolder holder, int position) {
    ...
    public ActivityAcceptChallengeAdapter(List<ChallengeDetails> challengeDetailsList, Context context) {
