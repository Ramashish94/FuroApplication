...
public class ContentFeedDetailAdapter extends RecyclerView.Adapter<ContentFeedDetailAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull ContentFeedDetailAdapter.MyViewHolder holder, int position) {
