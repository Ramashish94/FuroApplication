...
package com.app.furoapp.widget.roundedProgress;
...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setup(Context context, AttributeSet attrs) {
        ...
        layoutBackground = (LinearLayout) findViewById(com.akexorcist.roundcornerprogressbar.R.id.layout_background);
        layoutProgress = (LinearLayout) findViewById(com.akexorcist.roundcornerprogressbar.R.id.layout_progress);
        layoutSecondaryProgress = (LinearLayout) findViewById(com.akexorcist.roundcornerprogressbar.R.id.layout_secondary_progress);
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress);

        radius = (int) typedArray.getDimension(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcRadius, dp2px(DEFAULT_PROGRESS_RADIUS));
        padding = (int) typedArray.getDimension(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcBackgroundPadding, dp2px(DEFAULT_BACKGROUND_PADDING));

        isReverse = typedArray.getBoolean(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcReverse, false);

        max = typedArray.getFloat(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcMax, DEFAULT_MAX_PROGRESS);
        progress = typedArray.getFloat(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcProgress, DEFAULT_PROGRESS);
        secondaryProgress = typedArray.getFloat(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcSecondaryProgress, DEFAULT_SECONDARY_PROGRESS);

        int colorBackgroundDefault = context.getResources().getColor(com.akexorcist.roundcornerprogressbar.R.color.round_corner_progress_bar_background_default);
        colorBackground = typedArray.getColor(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcBackgroundColor, colorBackgroundDefault);
        int colorProgressDefault = context.getResources().getColor(com.akexorcist.roundcornerprogressbar.R.color.round_corner_progress_bar_progress_default);
        colorProgress = typedArray.getColor(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcProgressColor, colorProgressDefault);
        int colorSecondaryProgressDefault = context.getResources().getColor(com.akexorcist.roundcornerprogressbar.R.color.round_corner_progress_bar_secondary_progress_default);
        colorSecondaryProgress = typedArray.getColor(com.akexorcist.roundcornerprogressbar.R.styleable.RoundCornerProgress_rcSecondaryProgressColor, colorSecondaryProgressDefault);
        typedArray.recycle();
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            public BaseRoundCornerProgressBar.SavedState createFromParcel(Parcel in) {
                return new BaseRoundCornerProgressBar.SavedState(in);
            }

            public BaseRoundCornerProgressBar.SavedState[] newArray(int size) {
                return new BaseRoundCornerProgressBar.SavedState[size];
            }
        };
    }
