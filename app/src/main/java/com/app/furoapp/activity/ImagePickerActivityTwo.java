...
public class ImagePickerActivityTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_picker_two);
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.light_blue));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.light_blue));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.light_blue));
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImagePickerActivityTwo.this, getPackageName() + ".provider", image);
    }
