...
public class WaterIntakeMonitor {
    ...
    @SerializedName("recommended_water_in_litre")
    @Expose
    private Double recommendedWaterInLitre;
    ...
    public Double getRecommendedWaterInLitre() {
        return recommendedWaterInLitre;
    }

    public void setRecommendedWaterInLitre(Double recommendedWaterInLitre) {
        this.recommendedWaterInLitre = recommendedWaterInLitre;
    }
    ...
    public Object getTakenWaterInMl() {
        return takenWaterInMl;
    }

    public void setTakenWaterInMl(Object takenWaterInMl) {
