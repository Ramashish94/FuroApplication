...
public class ChallengeDraftMapAdapter extends RecyclerView.Adapter<ChallengeDraftMapAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public ChallengeDraftMapAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.challangedraftitemmap, parent, false);

        return new ChallengeDraftMapAdapter.MyViewHolder(itemView);
    }
    ...
    public ChallengeDraftMapAdapter(List<ChallengeDetails> challengeDetailsList, Context context) {
