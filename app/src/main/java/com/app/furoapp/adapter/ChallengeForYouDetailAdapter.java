...
public class ChallengeForYouDetailAdapter extends RecyclerView.Adapter<ChallengeForYouDetailAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public ChallengeForYouDetailAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.challangeforyouandforyouitem, parent, false);

        return new ChallengeForYouDetailAdapter.MyViewHolder(itemView);
    }
    ...
    public ChallengeForYouDetailAdapter(List<ChallengeDetails> challengeDetailsList, Context context) {
