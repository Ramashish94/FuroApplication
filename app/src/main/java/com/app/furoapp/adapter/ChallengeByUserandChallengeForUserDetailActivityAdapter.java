...
public class ChallengeByUserandChallengeForUserDetailActivityAdapter extends RecyclerView.Adapter<ChallengeByUserandChallengeForUserDetailActivityAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public ChallengeByUserandChallengeForUserDetailActivityAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.challangebyyouandforyouitem, parent, false);

        return new ChallengeByUserandChallengeForUserDetailActivityAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ChallengeByUserandChallengeForUserDetailActivityAdapter.MyViewHolder holder, int position) {
    ...
    public ChallengeByUserandChallengeForUserDetailActivityAdapter(List<ChallengeDetails> challengeDetailsList, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            byRepsImage=itemView.findViewById(R.id.Byreps);
