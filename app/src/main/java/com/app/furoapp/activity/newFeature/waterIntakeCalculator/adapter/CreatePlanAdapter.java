...
public class CreatePlanAdapter extends RecyclerView.Adapter<CreatePlanAdapter.MyViewHolder> {
    ...
    public CreatePlanAdapter(Context applicationContext, List<AllPlan>allPlanList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tvWaterTake.setText("Every" + allPlan.getRecommendedDurationInMins()+" minutes");
    }
