...
public class FetchGlassAdapter extends RecyclerView.Adapter<FetchGlassAdapter.MyViewHolder> {
    ...
    public FetchGlassAdapter(Context applicationContext, List<UserGlassSize> userGlassSizeList1,GlassClickCallBack glassClickCallBack) {
