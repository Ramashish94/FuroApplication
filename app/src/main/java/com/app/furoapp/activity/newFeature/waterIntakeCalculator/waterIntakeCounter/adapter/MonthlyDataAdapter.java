...
public class MonthlyDataAdapter extends RecyclerView.Adapter<MonthlyDataAdapter.MyViewHolder> {
    ...
    public MonthlyDataAdapter(Context applicationContext, List<RestorePlanResponse> restorePlanResponseList) {
