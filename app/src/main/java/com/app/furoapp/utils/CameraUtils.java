...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
                ...
                VideoRecoringViewAct.GALLERY_DIRECTORY_NAME);

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e(VideoRecoringViewAct.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + VideoRecoringViewAct.GALLERY_DIRECTORY_NAME + " directory");
                return null;
            }
        }
        ...
        File mediaFile;
         if (type == VideoRecoringViewAct.MEDIA_TYPE_VIDEO) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "VID_" + timeStamp + "." + VideoRecoringViewAct.VIDEO_EXTENSION);
        } else {
            return null;
        }
